  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-muted/30 to-background">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/76514b43-4581-49b0-a1fb-2a8ebbf06283/files/b120ac56-9157-4d82-8392-77e9c04fdaec.jpg"
          alt="Фотосалон"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center py-32">
        <div className="space-y-8">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-light tracking-tight text-balance">
            Ваши лучшие
            <span className="block font-semibold mt-2">Фотографии</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance leading-relaxed">
            Профессиональная фотосъёмка, печать фото и документы на паспорт — всё рядом с вашим домом
          </p>
